...
namespace Biblioteca
{
    public class Centimetro
    {
        ...
        public static explicit operator double(Centimetro centimetroUno) //ya es doble, explicita perdida de datos
        {
            return centimetroUno.cantidadDeCentimetros;
        }
        public static implicit operator int(Centimetro centimetroUno) //implicita no hay perdida de datos
        {
        ...
        public static bool operator !=(Centimetro centimetroUno, Centimetro centimetroDos)
        {
            return !(centimetroUno == centimetroDos); //ya esta definido en el ==, seria redundante poner el cantidad de cent
        }
        #endregion
    }
}
